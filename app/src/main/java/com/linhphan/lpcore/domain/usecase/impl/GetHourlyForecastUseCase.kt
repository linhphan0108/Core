...
) : SuspendUseCase<IGetHourlyForecastUseCase.Params, Forecasts>(ioDispatcher), IGetHourlyForecastUseCase {

    override suspend fun execute(parameters: IGetHourlyForecastUseCase.Params): Result<Forecasts> {
